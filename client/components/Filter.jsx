...
const Filter = ({ listAllDetails, filteredItems, filterFunc}) => {
    ...
    const getStyles = () => {
        ...
        if (width >= 900) styles.SectionedMultiSelect.selectToggleText.fontSize = 26
        else if (width >= 700) styles.SectionedMultiSelect.selectToggleText.fontSize = 22
        else if (width >= 500) styles.SectionedMultiSelect.selectToggleText.fontSize = 18
